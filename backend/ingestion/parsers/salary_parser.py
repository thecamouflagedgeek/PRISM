...
class SalaryParser:
    ...
    def parse(self, image_path: str):
        ...
        if hasattr(self.ocr, "extract_text_from_pdf"):
            ...
            full_text = self.ocr.extract_text_from_pdf(
                image_path
            )
            ...
            raise ValueError(
                "Unsupported OCR engine provided"
            )

        if hasattr(self.ocr, "clean_text"):

            full_text = self.ocr.clean_text(
                full_text
            )
...
"nps_contribution": [
    ...
    "npscontribution"
        ...
        for field, aliases in salary_aliases.items():
            ...
            salary_data[field] = extract_amount_after_label(
                aliases
            )
        ...
        if totals:
            ...
            salary_data["gross_salary"] = float(
            ...
            if gross > 0:
                ...
                salary_data["gross_salary"] = round(
                    gross,
                    2
                )
        ...
        if (
            ...
            salary_data.get("gross_salary")
            and
            salary_data.get("net_salary")
            and
